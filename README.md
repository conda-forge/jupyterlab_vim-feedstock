...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab_vim-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12796&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab_vim-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab_vim` can be installed with:

```
conda install jupyterlab_vim
```

It is possible to list all of the versions of `jupyterlab_vim` available on your platform with:
